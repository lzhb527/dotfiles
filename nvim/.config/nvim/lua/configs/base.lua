...
vim.keymap.set("v", "<LeftRelease>", "y gv", { noremap = true, silent = true })
opt.guifont = "DroidSansMono_Nerd_Font:h11" -- GUI 客户端（如 Neovide）下的字体与字号设置
opt.guicursor = "n-v-c-sm:block,i-ci-ve:ver25,r-cr-o:hor20,t:block" -- Normal/Visual 方块，Insert 竖线，Replace/Operator 下划线（终端仅认 block/竖线/下划线，模式切换可触发 ripple_cursor.glsl）
