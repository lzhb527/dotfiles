...
require("lazy").setup({
	...
	{
		"kylechui/nvim-surround", -- 加/改/删包围符号 (gza/gzc/gzd)；键位避让 Flash 的 s/S
		event = "VeryLazy",
		init = function()
			vim.g.nvim_surround_no_normal_mappings = true
			vim.g.nvim_surround_no_visual_mappings = true -- 保留插入模式默认 <C-g>s/<C-g>S
		end,
	...
	{
		"sphamba/smear-cursor.nvim", -- 光标移动拖尾动画（<leader>uc 开关）
		event = "VeryLazy",
