...
layouts = [
    #layout.Columns(border_focus_stack='#00ffff', border_focus='#00ffff',border_normal_stack='#00ffff',border_on_single='True', border_width=2,margin=6),
    layout.Max(border_focus='#00ffff',border_width=2,margin=6),
    ...
    # layout.Tile(),
    # layout.TreeTab(),
     layout.TreeTab(border_focus='#00ffff',border_width=2,margin=6,active_bg='#08bdba',bg_color='#161616'),
    # layout.VerticalTile(),
    # layout.Zoomy(),
]
